...
@class SKCaptureSessionManager, SKScannerEmptyView;
...
@interface SKScannerViewController : UIViewController {
	id <SKScannerViewControllerDelegate> _delegate;
	SKCaptureSessionManager *_captureManager;

	UIImageView *_guideBarNorthEast;
	UIImageView *_guideBarNorthWest;
	UIImageView *_guideBarSouthEast;
	UIImageView *_guideBarSouthWest;	
	
	SKScannerEmptyView *_emptyView;
